...
STRATEGY_REGISTRY: Dict[str, Dict[str, Any]] = {
    ...
    "RSIStrategy": {
        ...
        "timeframe": "15m",
        "symbols": ["BTC/USDT"],
        "backtest": {"supported": True, "description": "RSI超卖入场、超买离场", "optimization_grid": {"period": [10, 14, 21], "oversold": [20, 25, 30], "overbought": [65, 70, 75]}},
    },
    ...
    "MeanReversionStrategy": {
        ...
        "timeframe": "1h",
        "symbols": ["BTC/USDT"],
        "backtest": {"supported": True, "description": "Z-Score均值回归策略", "optimization_grid": {"lookback_period": [14, 20, 30], "entry_z_score": [1.5, 2.0, 2.5]}},
    },
    ...
    "TriangularArbitrageStrategy": {
        ...
        "risk": "high",
        "usage": "三角路径套利",
        "defaults": {"base_currency": "USDT", "min_profit": 0.002, "alpha_threshold": 0.002, "consider_fees": True, "fee_rate": 0.0007, "bridge_assets": ["ETH", "BNB", "SOL"], "max_opportunities": 2, "cooldown_min": 1, "max_spread": 0.03},
        "timeframe": "5m",
        "symbols": ["BTC/USDT"],
    ...
    "MarketSentimentStrategy": {
        ...
        "risk": "medium",
        "usage": "恐慌贪婪指数",
        "defaults": {"fear_threshold": 25, "greed_threshold": 75, "lookback_period": 7, "stop_loss_pct": 0.04, "take_profit_pct": 0.09, "timeout_sec": 6},
        "timeframe": "15m",
        "symbols": ["BTC/USDT"],
        "backtest": {"supported": True, "description": "宏观情绪策略", "optimization_grid": {"lookback_period": [12, 24, 36], "panic_threshold": [-0.06, -0.04, -0.03], "euphoria_threshold": [0.03, 0.04, 0.06]}},
    },
    "SocialSentimentStrategy": {
        "category": "宏观",
        "risk": "medium",
        "usage": "社媒情绪分析",
        "defaults": {"positive_threshold": 0.2, "negative_threshold": -0.2, "min_mentions": 30, "stop_loss_pct": 0.04, "take_profit_pct": 0.09, "timeout_sec": 6},
        "timeframe": "15m",
        "symbols": ["BTC/USDT"],
        "backtest": {"supported": True, "description": "社媒情绪策略", "optimization_grid": {"lookback_period": [6, 12, 24], "enter_momentum": [0.008, 0.015, 0.02], "exit_momentum": [-0.01, -0.008, -0.005]}},
    },
    "FundFlowStrategy": {
        "category": "宏观",
        "risk": "medium",
        "usage": "交易所资金流",
        "defaults": {"inflow_threshold": 150000.0, "outflow_threshold": -150000.0, "min_imbalance_ratio": 0.03, "lookback_period": 7, "book_depth": 80, "stop_loss_pct": 0.04, "take_profit_pct": 0.09},
        "timeframe": "15m",
        "symbols": ["BTC/USDT"],
    ...
    "WhaleActivityStrategy": {
        ...
        "risk": "high",
        "usage": "巨鲸地址追踪",
        "defaults": {"min_whale_size": 100000.0, "accumulation_threshold": 2, "distribution_threshold": 2, "lookback_hours": 24, "trade_limit": 600, "stop_loss_pct": 0.04, "take_profit_pct": 0.09},
        "timeframe": "15m",
        "symbols": ["BTC/USDT"],
