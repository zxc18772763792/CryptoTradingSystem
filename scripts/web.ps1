...
function Show-Help {
    ...
    Write-Host "  .\web.bat ...            canonical control entry"
    Write-Host "  .\start_web_oneclick.bat one-click alias -> .\web.bat start -OpenBrowser"
    Write-Host "  .\start_once.bat         deprecated wrapper -> start_web_oneclick.bat"
    Write-Host ""
